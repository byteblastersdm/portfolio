        ...
        <Wrapper className='pt-[40%] sm:pt-[30%]'>
            <div>
                ...
                <h2 className={`font-semibold ${oxygen.className} leading-[3rem] flex gap-4 flex-col`}>
                    ...
                    <span className={`md:text-6xl text-2xl font-bold tracking-wider whitespace-nowrap`}>
                        a Full Stack Developer.
                    </span>
                </h2>
                <p className='md:w-1/2 w-full md:leading-[2rem] md:text-lg text-base md:mt-5 mt-2'>
                    I am a full stack developer based in Vadgaon Budruk, Pune, Maharashtra 411041. I love to build web and mobile applications using React, NextJS, ReactNative, Angular, NodeJS, ExpressJS, Postgres and other technologies.
                </p>
                <div className='flex gap-5 md:mt-10 mt-5'>
                    <Link href={'#projects'} className='md:px-6 px-5 md:text-lg text-base md:py-3 py-2 rounded-lg bg-gray-700 hover:bg-gray-900 text-white'>
                        My Projects
                    </Link>
                    <Link href='./Saddam_cv.pdf' target='_blank'>
                        <button className='md:px-6 px-5 md:text-lg text-base md:py-3 py-2 rounded-lg bg-gray-300 hover:bg-gray-300 text-gray-900'>
                            Download CV
                        </button>
                    </Link>
                </div>
