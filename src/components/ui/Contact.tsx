...
const Contact = () => {
    ...
    return (
        <Wrapper className='min-h-screen relative'>
            {/* Live Demo Section */}
            <section className="py-12 sm:mb-[4rem]">
                ...
                <div className="max-w-5xl mx-auto mb-6 flex flex-col md:flex-row justify-between items-center gap-4 bg-gray-900/50 p-4 rounded-2xl border border-gray-800" data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="glassmorphism p-2 md:p-4 rounded-3xl overflow-hidden shadow-2xl h-[700px] w-full max-w-5xl mx-auto border border-gray-800" data-aos="fade-up" data-aos-delay="200">
                    <iframe
            ...
            {/* Contact Section */}
            <section className='flex md:flex-row flex-col pt-16 pb-12 border-t border-gray-800 mt-10'>
                ...
                <div className='md:w-[50%] sm:w-full w-full flex flex-col md:pl-5 pl-5 justify-center' data-aos="fade-right" data-aos-delay="100">
                ...
                <div data-aos="fade-left" data-aos-delay="200" className="w-full md:w-[50%] mt-10 md:mt-0">
                    <ContactForm />
                </div>
            </section>
